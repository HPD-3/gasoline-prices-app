...
// Create fuel.js if it doesn't exist
const fuelFile = path.join(apiDir, 'fuel.js');
const fuelCode = `/**
...
if (!fs.existsSync(fuelFile)) {
  fs.writeFileSync(fuelFile, fuelCode, 'utf8');
  console.log('✓ Created api/fuel.js');
} else {
  console.log('✓ api/fuel.js already exists');
}
`;

fs.writeFileSync(fuelFile, fuelCode, 'utf8');
console.log('✓ Created/Updated api/fuel.js');
